...
namespace WebSocketListener.UnitTests
{
    ...
    public class With_WebSocket
    {
        ...
        public void With_WebSocket_CanReadSmallFrame()
        {
            ...
            using (WebSocket ws = new WebSocketRfc6455(ms,new WebSocketListenerOptions() { PingTimeout = Timeout.InfiniteTimeSpan },  new IPEndPoint(IPAddress.Parse("127.0.0.1"), 1), new IPEndPoint(IPAddress.Parse("127.0.0.1"), 2), handshake.Request,  handshake.NegotiatedExtensions))
            {
