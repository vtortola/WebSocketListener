...
namespace vtortola.WebSockets
{
    ...
    public sealed class xWebSocketReadState
    {
        ...
        public static readonly xWebSocketReadState Empty = new xWebSocketReadState() { BytesReaded = 2, BytesRemaining = 0, MessageType = WebSocketMessageType.Closing, IsCompleted = true };
    }
}
